...
#+begin_src emacs-lisp
  ...
  (define-key dired-mode-map (kbd "6") (lambda () (interactive) (find-alternate-file "~/Documents/UofT")))
  (define-key dired-mode-map (kbd "7") (lambda () (interactive) (find-alternate-file "~/dotfiles")))
  (define-key dired-mode-map (kbd "8") (lambda () (interactive) (find-alternate-file "~/.config")))
  (define-key dired-mode-map (kbd "9") (lambda () (interactive) (find-alternate-file "~/Documents/SummerCamp")))
